...
int UnitTests_Lab1::Battery_SizeAccessor() {
	...
	int scoreForTest = CalculatePointsForTest(LAB1_SIZE_ACCESSOR, totalDeductions);
...
FailResult UnitTests_Lab1::Fail_ReserveLargerCapacity_Array_SameMemoryAddressThanOriginal() {
	int randomStartingCapacity = 9;// RandomInt(2, 10);
	int randomLargerCapacity = 10;// RandomInt(randomStartingCapacity + 1, 20);
