...
#pragma region Test - Default Constructor (No Arguments)
	static int Battery_DefaultConstructorNoArgs();
...
#pragma region Test - Default Constructor (With Arguments)
	static int Battery_DefaultConstructorWithArgs();

	static FailResult Fail_DefaultConstructorWithArgs_Array_IncorrectAmountOfMemoryAllocated();
	static FailResult Fail_DefaultConstructorWithArgs_Array_AllocatedToValidAddress();
...
#pragma region Test - [] Operator (Read-Only)
	static int Battery_BracketOperator();

	static FailResult Fail_BracketOperator_UsesLoop();
...
#pragma region Test - Size Accessor
	static int Battery_SizeAccessor();
...
#pragma region Test - Capacity Accessor
	static int Battery_CapacityAccessor();
...
#pragma region Test - Reserve (Empty)
	static int Battery_ReserveEmpty();
...
#pragma region Test - Reserve (Double Capacity) 
	static int Battery_ReserveDoubleCapacity();
...
#pragma region Test - Reserve (Larger Capacity)
	static int Battery_ReserveLargerCapacity();
...
#pragma region Test - Reserve (Smaller Capacity) 
	static int Battery_ReserveSmallerCapacity();
...
#pragma region Test - Append (No Resize)
	static int Battery_AppendNoResize();
	...
	static FailResult Fail_AppendNoResize_Array_ValueWasAddedToMultipleIndices();
...
#pragma region Test - Append (Resize)
	static int Battery_AppendResize();

	static FailResult Fail_AppendResize_Array_ArrayIsNotDoubled();
	...
	static FailResult Fail_AppendResize_Array_ValueWasAddedToMultipleIndices();
...
#pragma region Test - Destructor
	...
	static FailResult Fail_Destructor_DoesNotDeleteOrCallClear();
...
#pragma region Test - Assignment Operator
	static int Battery_AssignmentOperator();
	...
	static FailResult Fail_AssignmentOperator_Array_DataChangedInOriginalObject();
...
#pragma region Test - Copy Constructor
	static int Battery_CopyConstructor();
